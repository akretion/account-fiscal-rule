    ...
    def _compute_ecotax(self):
        for ecotaxline in self:
            ...
            if ecotaxline.force_amount_unit:
                ...
                # product weight can be different by variant or can be defined in template for all variants
                amount = ecotax_classif.ecotax_coef * (
                    ecotaxline.product_id.weight or ecotaxline.product_id.product_tmpl_id.weight or 0.0
                )
            else:
